        ...
        <nav className="blue darken-3">
          <div className="nav-wrapper">
            ...
            <ul className="right hide-on-small-only">
              <li><Link to="/"><i className="fa fa-users"></i> Cars</Link></li>
            </ul>
            <ul className="side-nav" id="main-menu">
              <li><Link to="/"><i className="fa fa-users"></i> Cars</Link></li>
              <li><Link to="/cars/add"><i className="fa fa-plus"></i> Add Car</Link></li>
              <li><Link to="/cars/:id"><i className="fa fa-plus"></i> Car By ID</Link></li>
